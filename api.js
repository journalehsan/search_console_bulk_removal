(function() {
    var da = function(a) { var b = 0; return function() { return b < a.length ? { done: !1, value: a[b++] } : { done: !0 } } },
        g = "function" == typeof Object.defineProperties ? Object.defineProperty : function(a, b, c) { if (a == Array.prototype || a == Object.prototype) return a;
        ...
        fa = ea(this),
        h = function(a, b) { if (b) a: { var c = fa;a = a.split("."); for (var d = 0; d < a.length - 1; d++) { var e = a[d]; if (!(e in c)) break a;
                    c = c[e] }
                a = a[a.length - 1];d = c[a];b = b(d);b != d && null != b && g(c, a, { configurable: !0, writable: !0, value: b }) } };
    h("Symbol", function(a) { if (a) return a; var b = function(f, k) { this.B = f;
            g(this, "description", { configurable: !0, writable: !0, value: k }) };
        b.prototype.toString = function() { return this.B }; var c = "jscomp_symbol_" + (1E9 * Math.random() >>> 0) + "_",
            d = 0,
            e = function(f) { if (this instanceof e) throw new TypeError("Symbol is not a constructor"); return new b(c + (f || "") + "_" + d++, f) }; return e });
    h("Symbol.iterator", function(a) { if (a) return a;
    ...
    var ha = function(a) { a = { next: a };
            a[Symbol.iterator] = function() { return this }; return a },
        ia = function(a, b, c) { if (null == a) throw new TypeError("The 'this' value for String.prototype." + c + " must not be null or undefined"); if (b instanceof RegExp) throw new TypeError("First argument to String.prototype." + c + " must not be a regular expression"); return a + "" };
    h("String.prototype.endsWith", function(a) { return a ? a : function(b, c) { var d = ia(this, b, "endsWith");
            b += "";
            void 0 === c && (c = d.length);
            c = Math.max(0, Math.min(c | 0, d.length)); for (var e = b.length; 0 < e && 0 < c;)
                if (d[--c] != b[--e]) return !1;
            return 0 >= e } });
    var ja = function(a, b) { a instanceof String && (a += ""); var c = 0,
            d = !1,
    ...
    h("Array.prototype.entries", function(a) { return a ? a : function() { return ja(this, function(b, c) { return [b, c] }) } });
    h("Object.is", function(a) { return a ? a : function(b, c) { return b === c ? 0 !== b || 1 / b === 1 / c : b !== b && c !== c } });
    h("Array.prototype.includes", function(a) { return a ? a : function(b, c) { var d = this;
    ...
    h("String.prototype.includes", function(a) { return a ? a : function(b, c) { return -1 !== ia(this, b, "includes").indexOf(b, c || 0) } });
    ...
    */
    var n = this || self,
        ...
        la = function(a, b) {
            ...
            a.G = function(d, e, f) { for (var k = Array(arguments.length - 2), m = 2; m < arguments.length; m++) k[m - 2] = arguments[m]; return b.prototype[e].apply(d, k) } },
        t = function(a) { return a };

    function w(a, b) { if (Error.captureStackTrace) Error.captureStackTrace(this, w);
    ...
    function y(a, b) { a = a.split("%s"); for (var c = "", d = a.length - 1, e = 0; e < d; e++) c += a[e] + (e < b.length ? b[e] : "%s");
        w.call(this, c + a[d]) }
    la(y, w);
    y.prototype.name = "AssertionError";
    var ma = function(a, b) { throw new y("Failure" + (a ? ": " + a : ""), Array.prototype.slice.call(arguments, 1)); };
    var z = function(a, b) { this.name = a;
        this.value = b };
    z.prototype.toString = function() { return this.name };
    var B = new z("OFF", Infinity),
        na = new z("WARNING", 900),
        oa = new z("CONFIG", 700),
        pa = function() { this.g = 0;
            this.clear() },
        C;
    pa.prototype.clear = function() { this.l = Array(this.g);
        this.o = -1;
        this.s = !1 };
    var F = function(a, b, c) { this.reset(a || B, b, c, void 0, void 0) };
    F.prototype.reset = function() {};
    var qa = function(a, b) { this.level = null;
            this.C = [];
            this.parent = (void 0 === b ? null : b) || null;
            this.children = [];
            this.D = { i: function() { return a } } },
        ra = function(a) { if (a.level) return a.level; if (a.parent) return ra(a.parent);
            ma("Root logger has no level set."); return B },
        sa = function(a, b) { for (; a;) a.C.forEach(function(c) { c(b) }), a = a.parent },
        ta = function() { this.entries = {}; var a = new qa("");
            a.level = oa;
            this.entries[""] = a },
        G, H = function(a, b) {
            var c = a.entries[b];
        ...
        I = function() { G || (G = new ta); return G };
    /*

     SPDX-License-Identifier: Apache-2.0
    */
    var ua = [],
        va = function(a) { var b; if (b = H(I(), "safevalues").D) { var c = "A URL with content '" + a + "' was sanitized away.",
                    d = na; if (a = b)
                    if (a = b && d) { a = d.value; var e = b ? ra(H(I(), b.i())) : B;
                        a = a >= e.value }
                if (a) { d = d || B;
                    a = H(I(), b.i()); "function" === typeof c && (c = c());
                    C || (C = new pa);
                    e = C;
                    b = b.i(); if (0 < e.g) { var f = (e.o + 1) % e.g;
                        e.o = f;
                        e.s ? (e = e.l[f], e.reset(d, c, b), b = e) : (e.s = f == e.g - 1, b = e.l[f] = new F(d, c, b)) } else b = new F(d, c, b);
                    sa(a, b) } } }; - 1 === ua.indexOf(va) && ua.push(va);
    /*
    ...
    var J = window,
        ...
        xa = function() {},
        ya = /\[native code\]/,
        L = function(a, b, c) { return a[b] = a[b] || c },
        Aa = function(a) { a = a.sort(); for (var b = [], c = void 0, d = 0; d < a.length; d++) { var e = a[d];
                e != c && b.push(e);
                c = e } return b },
        M = function() { var a; if ((a = Object.create) && ya.test(a)) a = a(null);
            else { a = {}; for (var b in a) a[b] = void 0 } return a },
        P = L(J, "gapi", {});
    var Q = {};
    Q = L(J, "___jsl", M());
    L(Q, "I", 0);
    L(Q, "hel", 10);
    var Ba = function() { var a = wa.href; if (Q.dpo) var b = Q.h;
            else { b = Q.h; var c = RegExp("([#].*&|[#])jsh=([^&#]*)", "g"),
                    d = RegExp("([?#].*&|[?#])jsh=([^&#]*)", "g"); if (a = a && (c.exec(a) || d.exec(a))) try { b = decodeURIComponent(a[2]) } catch (e) {} } return b },
        Ca = function(a) { var b = L(Q, "PQ", []);
            Q.PQ = []; var c = b.length; if (0 === c) a();
            else
                for (var d = 0, e = function() {++d === c && a() }, f = 0; f < c; f++) b[f](e) },
        R = function(a) { return L(L(Q, "H", M()), a, M()) };
    var S = L(Q, "perf", M()),
        Da = L(S, "g", M()),
        Ea = L(S, "i", M());
    L(S, "r", []);
    M();
    M();
    var T = function(a, b, c) { var d = S.r; "function" === typeof d ? d(a, b, c) : d.push([a, b, c]) },
        U = function(a, b, c) { b && 0 < b.length && (b = Fa(b), c && 0 < c.length && (b += "___" + Fa(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = L(Ea, "_p", M()), L(b, c, M())[a] = (new Date).getTime(), T(a, "_p", c)) },
        Fa = function(a) { return a.join("__").replace(/\./g, "_").replace(/\-/g, "_").replace(/,/g, "_") };
    var Ga = M(),
        V = [],
        W = function(a) { throw Error("Bad hint: " + a); };
    V.push(["jsl", function(a) { for (var b in a)
            if (Object.prototype.hasOwnProperty.call(a, b)) { var c = a[b]; "object" == typeof c ? Q[b] = L(Q, b, []).concat(c) : L(Q, b, c) }
    ...
    var Ha = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        Qa = function(a) {
            ...
            for (var b = a.substring(1).split("/"), c = []; b.length;) { a = b.shift(); if (!a.length || 0 == a.indexOf(".")) W("empty/relative directory");
        ...
        Ra = function(a) { for (var b = [], c = 0, d = a.length; c < d; ++c) { var e = a[c].replace(/\./g, "_").replace(/-/g, "_");
                La.test(e) && b.push(e) } return b.join(",") },
        X = function(a, b, c) { a = a[b];!a && c && W("missing: " + b); if (a) { if (Ja.test(a)) return a;
                W("invalid: " + b) } return null },
    ...
    var Y = decodeURI("%73cript"),
        Ta = /^[-+_0-9\/A-Za-z]+={0,2}$/,
        Ua = function(a, b) { for (var c = [], d = 0; d < a.length; ++d) { var e = a[d],
                    f; if (f = e) { a: { for (f = 0; f < b.length; f++)
                            if (b[f] === e) break a;f = -1 }
                    f = 0 > f }
                f && c.push(e) } return c },
        Va = function() { var a = Q.nonce; return void 0 !== a ? a && a === String(a) && a.match(Ta) ? a : Q.nonce = null : K.querySelector ? (a = K.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(Ta) ? Q.nonce = a : Q.nonce = null) : null : null },
        Xa = function(a) {
        ...
        Wa = function(a) { var b = K.createElement(Y);
        ...
        Za = function(a, b, c) { Ya(function() { var d = b === Ba() ? L(P, "_", M()) : M();
                d = L(R(b), "_", d);
                a(d) }, c) },
        ab = function(a, b) {
            var c =
            ...
            var d = (b = c) && b._c;
            if (d)
                for (var e = 0; e < V.length; e++) { var f = V[e][0],
                        k = V[e][1];
        ...
        $a = function(a, b, c) {
            ...
            var ba = L(R(c), "L", []).sort(),
                fb = Q.le || [],
                N = [].concat(l),
                za = function(x, D) { if (aa) return 0;
                    J.clearTimeout(A);
                    ba.push.apply(ba, r); var E = ((P || {}).config || {}).update;
                    E ? E(f) : f && L(Q, "cu", []).push(f); if (D) { U("me0", x, N); try { Za(D, c, q) } finally { U("me1", x, N) } } return 1 };
            0 < k && (A = J.setTimeout(function() { aa = !0;
                m() }, k));
            var r = Ua(a, ba);
            if (r.length) {
                r = Ua(a, l);
                ...
                u[v] = function(x) {
                    ...
                    var D = function(O) {
                        ...
                        E = function() { var O = u[v + 1];
                            O && O() };
                    0 < v && u[v - 1] ? u[v] = function() { D(E) } : D(E)
                };
                if (r.length) { var ca = "loaded_" + Q.I++;
                    P[ca] = function(x) { u[v](x);
                        P[ca] = null };
                    a = Pa(c, r, "gapi." + ca, l, fb);
                    l.push.apply(l, r);
                    U("ml0", r, N);
                    b.sync || J.___gapisync ? Xa(a) : Wa(a) } else u[v](xa)
            } else za(r) && e && e()
        },
        bb;
    var cb = null,
        db = n.trustedTypes;
    if (db && db.createPolicy) try { cb = db.createPolicy("gapi#gapi", { createHTML: t, createScript: t, createScriptURL: t }) } catch (a) { n.console && n.console.error(a.message) }
    bb = cb;
    var Z = bb;
    var Ya = function(a, b) { if (Q.hee && 0 < Q.hel) try { return a() } catch (c) { b && b(c), Q.hel--, ab("debug_error", function() { try { window.___jsl.hefn(c) } catch (d) { throw c; } }) } else try { return a() } catch (c) { throw b && b(c), c; } };
    var eb = P.load;
    eb && L(Q, "ol", []).push(eb);
    P.load = function(a, b) { return Ya(function() { return ab(a, b) }) };
    V.unshift(["url", function(a, b, c) {!a || b && "" !== b || !a.endsWith(".js") || (a = a.substring(0, a.length - 3), b = a.lastIndexOf("/") + 1, b >= a.length || (a = a.substr(b).split(":").filter(function(d) { return !["api", "platform"].includes(d) }), c.features = a)) }]);
    ...
    window.gapi.load("", {
        ...
        _c: {
            ...
            jsl: {
                ci: {
                    "oauth-flow": { authUrl: "https://accounts.google.com/o/oauth2/auth", proxyUrl: "https://accounts.google.com/o/oauth2/postmessageRelay", disableOpt: !0, idpIframeUrl: "https://accounts.google.com/o/oauth2/iframe", usegapi: !1 },
                    debug: { reportExceptionRate: 1, forceIm: !1, rethrowException: !0, host: "https://apis.google.com" },
                    enableMultilogin: !0,
                    "googleapis.config": { auth: { useFirstPartyAuthV2: !0 }, root: "https://content.googleapis.com", "root-1p": "https://clients6.google.com" },
                    inline: { css: 1 },
